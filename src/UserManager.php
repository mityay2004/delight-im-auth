...
//    protected $db;
     ...
     */
    protected function __construct($dbTablePrefix = null, $dbSchema = null) {
    ...
    protected function createUserInternal($requireUniqueUsername, $email, $password, $username = null, callable $callback = null) {
        ...
        if ($requireUniqueUsername) {
            ...
            if ($username !== null) {
                ...
                $occurrencesOfUsername = (int)$this->CI->db
        ...
        $newUserId = (int)$this->CI->db->insert_id();
    ...
    protected function deleteRememberDirectiveForUserById($userId, $selector = null) {
        ...
        $this->CI->db
                ->where($whereMappings)
                ->delete($this->makeTableName('users_remembered'));
    }
